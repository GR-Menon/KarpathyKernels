...
# implementing gradient accumulation to simulate very large batch sizes
...
# Implementing cosine learning rate scheduling
max_lr = 6e-4
min_lr = max_lr * 0.1
warmup_steps = 10
max_steps = 50
...
def get_lr(it):
    ...
    # if it > lr_decay_iters, return minimum LR
    if it > max_steps:
        return min_lr
    # in between, use cosine decay down to minimum LR
